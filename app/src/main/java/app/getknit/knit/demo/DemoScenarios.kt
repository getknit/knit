...
data class DemoReaction(val reactor: Slot, val emoji: String, val minsAgo: Long)
...
data class DemoPeer(val slot: Slot, val name: String, val status: String, val verified: Boolean = false)
...
data class DemoThread(val peer: Slot, val read: Boolean, val messages: List<DemoMsg>)
...
fun demoScenarioFor(theme: String): DemoScenario = when (theme) {
...
private val HIKING_SCENARIO = DemoScenario(
    theme = "hiking",
    meName = "Maya Okonkwo",
    ...
    nearby = listOf(
        ...
        DemoMsg(
            "demo-nearby-4", Slot.SAM, "Trail's clear up top @Maya Okonkwo 🎉 come join us!", 70,
            mentionsMe = true,
        ),
        DemoMsg("demo-nearby-5", Slot.DANI, "Saved you a spot by the fire 🔥", 66),
        DemoMsg("demo-nearby-6", Slot.ME, "On my way — give me 20.", 64),
        DemoMsg(
            "demo-nearby-7", Slot.LENA, "Heads up: bridge near the falls is out, take the upper loop.", 40,
            reactions = listOf(
    ...
    groupMessages = listOf(
        ...
        DemoMsg("demo-group-4", Slot.ME, "Works for me. I'll grab snacks.", 290, reactions = listOf(DemoReaction(Slot.SAM, "👍", 289))),
...
private val FESTIVAL_SCENARIO = DemoScenario(
    theme = "festival",
    meName = "Zara Vance",
    ...
    nearby = listOf(
        ...
        DemoMsg(
            "fest-nearby-4", Slot.SAM, "Art car 'Dusty Rhino' rolling to deep playa @Zara Vance 🦏 hop on!", 70,
            mentionsMe = true,
        ),
        ...
        DemoMsg(
            "fest-nearby-7", Slot.LENA, "Dust storm rolling in from the west — goggles up! 🥽", 40,
            reactions = listOf(
                DemoReaction(Slot.SAM, "👍", 39),
                DemoReaction(Slot.THEO, "👍", 39),
                DemoReaction(Slot.ME, "👍", 38),
    ...
    groupMessages = listOf(
        ...
        DemoMsg(
            "fest-group-4", Slot.ME, "Works for me. I'll bring the LED totem 🔆", 290,
