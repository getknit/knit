...
object Alias {
     ...
     */
    internal fun aliasForExcluding(nodeId: String, blocked: Set<String>): String {
    ...
    private fun fnv1a(seed: ULong, bytes: ByteArray): ULong {
        var h = seed
        for (b in bytes) {
    ...
    private val ADJECTIVES = listOf(
        "Able", "Agile", "Ample", "Arctic", "Ardent", "Azure", "Balmy", "Blissful", "Bold", "Brave",
        "Breezy", "Bright", "Brisk", "Bubbly", "Calm", "Caring", "Cheerful", "Chipper", "Civic",
        "Classy", "Clever", "Coastal", "Cosmic", "Cozy", "Crafty", "Crimson", "Crisp", "Crystal",
        "Curious", "Dapper", "Daring", "Dazzling", "Deft", "Dreamy", "Driven", "Dynamic", "Eager",
        "Earnest", "Elated", "Electric", "Elegant", "Emerald", "Enlightened", "Epic", "Fabled",
        "Fair", "Fancy", "Fearless", "Festive", "Fleet", "Fluffy", "Fond", "Frosty", "Gallant",
        "Gentle", "Gilded", "Gleaming", "Glowing", "Golden", "Graceful", "Grand", "Grassy", "Hardy",
        "Hearty", "Helpful", "Heroic", "Honest", "Hopeful", "Humble", "Ideal", "Indigo", "Inky",
        "Intrepid", "Ivory", "Jaunty", "Jolly", "Jovial", "Joyful", "Keen", "Kind", "Kindly",
        "Lively", "Loyal", "Lucid", "Lucky", "Lunar", "Lush", "Magic", "Mellow", "Merry", "Mighty",
        "Mild", "Minty", "Misty", "Modern", "Modest", "Mossy", "Neat", "Nifty", "Nimble", "Noble",
        "Pastel", "Patient", "Peaceful", "Pearly", "Perky", "Placid", "Plucky", "Plush", "Polar",
        "Polished", "Posh", "Prime", "Pristine", "Proud", "Quaint", "Quick", "Quiet", "Quirky",
        "Radiant", "Rapid", "Regal", "Robust", "Rosy", "Royal", "Rugged", "Rustic", "Sage", "Sandy",
        "Scarlet", "Serene", "Sharp", "Shining", "Shiny", "Silent", "Silken", "Silver", "Sleek",
        "Smart", "Smiling", "Smooth", "Snappy", "Snowy", "Solar", "Sparkly", "Spirited", "Spry",
        "Stalwart", "Starry", "Steady", "Stellar", "Sterling", "Stoic", "Sturdy", "Suave", "Sunny",
        "Sunlit", "Swift", "Tidy", "Tranquil", "Trusty", "Upbeat", "Valiant", "Velvet", "Verdant",
        "Vibrant", "Vivid", "Warm", "Whimsical", "Wily", "Winsome", "Wise", "Witty", "Woolly",
        "Zany", "Zealous", "Zesty", "Zippy",
    )

    /** Neutral nouns (animals, nature, gems, objects), capitalized. Disjoint from [ADJECTIVES]. */
    private val NOUNS = listOf(
        "Otter", "Falcon", "Fox", "Owl", "Wolf", "Bear", "Hawk", "Heron", "Sparrow", "Finch",
        "Robin", "Wren", "Lark", "Crane", "Swan", "Dove", "Raven", "Badger", "Bison", "Lynx",
        "Marten", "Mole", "Moose", "Newt", "Panda", "Puffin", "Quail", "Stoat", "Tapir", "Vole",
        "Yak", "Zebra", "Gazelle", "Ibex", "Koala", "Lemur", "Llama", "Manatee", "Meerkat",
        "Mongoose", "Narwhal", "Ocelot", "Pangolin", "Walrus", "Wombat", "Antelope", "Bobcat",
        "Caribou", "Cheetah", "Cobra", "Dolphin", "Gecko", "Iguana", "Jackal", "Jaguar", "Kestrel",
        "Kingfisher", "Kiwi", "Magpie", "Mallard", "Mantis", "Mink", "Octopus", "Osprey", "Pelican",
        "Penguin", "Pheasant", "Plover", "Python", "Salmon", "Seal", "Dormouse", "Skink", "Starling",
        "Stingray", "Tortoise", "Toucan", "Turtle", "Urchin", "Viper", "Marmot", "Whale",
        "Wolverine", "Ferret", "Hedgehog", "Hare", "Rabbit", "Squirrel", "Chipmunk", "Raccoon",
        "Armadillo", "Sloth", "Bluejay", "Cardinal", "Chickadee", "Nightingale", "Oriole",
        "Swallow", "Maple", "Willow", "Cedar", "Birch", "Aspen", "Alder", "Spruce", "Pine", "Fern",
        "Ivy", "Moss", "Clover", "Daisy", "Lily", "Lotus", "Poppy", "Tulip", "Aster", "River",
        "Brook", "Creek", "Lake", "Bay", "Cove", "Reef", "Dune", "Mesa", "Canyon", "Summit",
        "Ridge", "Glade", "Meadow", "Harbor", "Lagoon", "Comet", "Nova", "Nebula", "Quasar",
        "Pulsar", "Meteor", "Aurora", "Eclipse", "Galaxy", "Cosmos", "Zenith", "Ember", "Cinder",
        "Spark", "Flame", "Frost", "Mist", "Cloud", "Storm", "Thunder", "Breeze", "Zephyr",
        "Lantern", "Beacon", "Anchor", "Compass", "Sail", "Pixel", "Cipher", "Vector", "Quartz",
        "Onyx", "Opal", "Jade", "Topaz", "Amber", "Garnet", "Coral", "Pearl", "Agate", "Beryl",
        "Flint", "Slate", "Marble", "Granite", "Copper", "Cobalt", "Pewter", "Bronze", "Book",
    )
 ...
 */
fun displayNameFor(storedName: String?, nodeId: String): String =
    storedName?.takeIf { it.isNotBlank() } ?: Alias.aliasFor(nodeId)
