<!--
Thanks for contributing to Knit! Keep each merge request focused on a single change.
...
- [ ] Wire-format / custody / crypto changes note their compatibility impact (see `docs/WIRE_COMPAT.md`)
